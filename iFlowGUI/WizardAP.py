...
class AddProbe(PQW.QWizard):
    ...
    def next_print(self):
        logger.debug(f"Next{self.currentId()}")
        Flag_Error = 0
        if(self.currentId() == 1):
    ...
    def finish_print(self):
        logger.debug(f"Action:finish Page")
    #     #
    #     # stringEXE = 'DataImport.exe'
    #     # stringLog = ''
    #     # # Probe name  [STRING] -p
...
class Page1(PQW.QWizardPage):
    def __init__(self, parent=None):
        ...
        Layout_Page1_Left_1.addWidget(Label_FileName)
        #
        ...
        Layout_Page1_Left_1.addWidget(Page1.Combobox_ProbName)
        #
        ...
        #
        Layout_Page1_Left.addWidget(self.GroupBox_DataFile)
        # Groupbox Time
        ...
        #
        Layout_Page1_Left.addWidget(self.GroupBox_Time)
        # Groupbox Options
        ...
        #
        Layout_Page1_Left.addWidget(self.GroupBox_Options)
        #
    ...
    def on_SampleRate_Change(self):
        logger.debug('Page1 - on_SampleRate_Change')
    ...
    def on_SampleFreq_Change(self):
        logger.debug('Page1 - on_SampleFreq_Change')
        # Update fields SampleRate and SampleFreq
        try:
    ...
    def UpdateChart(self):
        logger.debug('Page1 - Update Chart')
        # Reset chart
    ...
    def on_Combobox_ProbName_change(self):
        logger.debug('Page1 - on_Combobox_ProbName_change')
    ...
    def on_Combobox_TimeSerie_change(self):
        logger.debug('Page1 - on_Combobox_TimeSerie_change')
        # Disconnect events
    ...
    def on_Combobox_TimeType_change(self):
        logger.debug('Page1 - on_Combobox_TimeType_change')
        # Disconect events
    ...
    def on_Button_Select_File_clicked(self):
        logger.debug('Page1 - on_Button_Select_File_clicked')
        # Disconect events
        ...
        if file_name:
            ...
            if Page1.Flag_Update: #! To finish
                ...
                if(Page1.Flag_Header == PQW.QMessageBox.Yes): # There is sensor's name in the datafile
                    Page1.DataNow = pd.read_csv(file_name) # Load Data
                    #
...
class Page2(PQW.QWizardPage):
    def __init__(self, parent=None):
        ...
        Layout_Page2_Left_1.addWidget(Label_SensFile)
        ...
        Layout_Page2_Left_1.addWidget(Page2.List_Sensor_File)
        #
        ...
        Layout_Page2_Left_2.addWidget(Page2.Button_Add_All)
        # Button Remove all
        ...
        Layout_Page2_Left_2.addWidget(Page2.Button_Remove_All)
        #
        ...
        Layout_Page2_Left_3.addWidget(Label_SensImpo)
        ...
        Layout_Page2_Left_3.addWidget(Page2.List_Sensor_Impo)
        #
    ...
    def UpdateChart(self):
        logger.debug('Page2 - Update Chart')
        # Reset chart
    ...
    def on_List_Sensor_File_event(self,item):
        logger.debug('Page2 - on_List_Sensor_File_event')
    ...
    def on_List_Sensor_Impo_event(self,item):
        logger.debug('Page2 - on_List_Sensor_Impo_event')
    ...
    def on_Button_Add_All_clicked(self):
        logger.debug('Page2 - on_Button_Add_All_clicked')
    ...
    def on_Button_Remove_All_clicked(self):
        logger.debug('Page2 - on_Button_Remove_All_clicked')
...
class Page3(PQW.QWizardPage):
    def __init__(self, parent=None):
        ...
        Layout_Page3_Left.addWidget(Page3.Table_Height)
        #
        Layout_Page3_Left_1 = PQW.QHBoxLayout()    
        ...
        Layout_Page3_Left_1.addWidget(Page3.Button_Imp_Geo)
        # Button Generate Geometry
        Page3.Button_Gen_Geo = PQW.QPushButton('Generate Geometry')
        Layout_Page3_Left_1.addWidget(Page3.Button_Gen_Geo)
        Page3.Button_Gen_Geo.clicked.connect(self.on_Button_Gen_Geo_clicked)
        #
        Layout_Page3_Left.addLayout(Layout_Page3_Left_1)
        #
        container_left.setMaximumWidth(int(VAR.GetWindowsSize(VAR)[0] * 2 / 3 / 4))
    ...
    def UpdateChart(self):
        logger.debug('Page3 - Update Chart')
    ...
    def on_Button_Imp_Geo_clicked(self):
        logger.debug('Page2 - on_Button_Imp_Geo_clicked')
        # Select the path of the datafile
        Options = PQW.QFileDialog.Options()
        Options |= PQW.QFileDialog.DontUseNativeDialog
    ...
    def on_Button_Gen_Geo_clicked(self):
        logger.debug('Page2 - on_Button_Gen_Geo_clicked')
...
class Page4(PQW.QWizardPage):
    def __init__(self, parent=None):
        ...
        Layout_Page4_Left.addWidget(Label_ImpoFrom)
        # 
        Page4.ImpoFromDateTime = PQW.QDateTimeEdit(self)
        Page4.ImpoFromDateTime.setDisplayFormat('yyyy-mm-dd hh:mm:ss') 
        Layout_Page4_Left.addWidget(Page4.ImpoFromDateTime)
        Page4.ImpoFromTime = PQW.QSpinBox(self)
        Layout_Page4_Left.addWidget(Page4.ImpoFromTime)
        # Label Import To
        Label_ImpoTo = PQW.QLabel('Import to:')
        Layout_Page4_Left.addWidget(Label_ImpoTo)
        # 
        Page4.ImpoToDateTime = PQW.QDateTimeEdit(self)
        Page4.ImpoToDateTime.setDisplayFormat('yyyy-mm-dd hh:mm:ss') 
        Layout_Page4_Left.addWidget(Page4.ImpoToDateTime)
        Page4.ImpoToTime = PQW.QSpinBox(self)
        Layout_Page4_Left.addWidget(Page4.ImpoToTime)
        #
        container_left.setMaximumWidth(int(VAR.GetWindowsSize(VAR)[0] * 2 / 3 / 4))
...
#
    def UpdateChart(self):
        logger.debug('Page4 - Update Chart')
        SensorToImport =  [str(Page2.List_Sensor_Impo.item(i).text()) for i in range(Page2.List_Sensor_Impo.count())]
        # Reset chart
